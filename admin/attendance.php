              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered">
                  <thead>
                    ...
                    <th width="17%">Name</th>
                    <th width="16%">Attendance Image</th>
                    <th width="15%">Time In</th>
                    <th width="11%">Time Out</th>
                  ...
                  <tbody>
                    <?php
                      ...
                      while($row = $query->fetch_assoc()){
                        ...
                        if(empty($row['time_in_img'])){
                          $attendance_img = "../images/no-image.jpg";
                        }else{
                          $attendance_img = $row['time_in_img'];
                        }
                        echo "
                          <tr>
                            ...
                            <td><img src='".$attendance_img."' width='150' height='100'></td>
